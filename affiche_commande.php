...
if(isset($_POST['etat'])){
    // Gestion du passage d'un état à un autre
    $etat = $_POST['etat'];
...
<main role="main">
  ...
  <!-- Si l'utilisateur est un employé ou un responsable, affiche le select 
  Sinon, affichage des boutons payer et annuler -->
  <?php if(isset($statut)){?>
  <div class="col-sm-10">
